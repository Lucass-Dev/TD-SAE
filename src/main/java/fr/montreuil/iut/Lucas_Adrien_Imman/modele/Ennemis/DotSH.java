...
public class DotSH extends Ennemy{
    public DotSH(int x, int y, Pane levelPane, Level level, Player player, int startDirection, ModeDeplacement md) {
        super(x, y, levelPane, level, 0, 30, player, 3, 30, 1, startDirection, 30, 3, md);
    }
