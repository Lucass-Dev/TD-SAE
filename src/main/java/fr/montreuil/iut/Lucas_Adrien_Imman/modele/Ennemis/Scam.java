...
public class Scam extends Ennemy{
    public Scam(int x, int y, Pane levelPane, Level level, Player player, int startDirection, ModeDeplacement md) {
        super(x, y, levelPane, level, 3, 10, player, 6, 10,0, startDirection, 20, 5, md);
    }
