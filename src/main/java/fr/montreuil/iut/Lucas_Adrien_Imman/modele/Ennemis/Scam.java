...
public class Scam extends Ennemy{
    public Scam(int x, int y, Pane levelPane, Environment environment, Player player, int startDirection) {
        super(x, y, levelPane, environment, 3, 10, player, 6, 10,0, startDirection, 20, 5);
    }
